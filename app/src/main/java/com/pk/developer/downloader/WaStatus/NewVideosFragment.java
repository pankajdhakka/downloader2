...
public class NewVideosFragment extends Fragment {
    ...
    public NewVideosFragment(String title, int colorId) {
        this.title = title;
...
//        textView.setTextColor(ContextCompat.getColor(getContext(), colorId));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.activity_new_videos_fragment, container, false);
        ...
        Button openwha=v.findViewById(R.id.openwha);
        openwha.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onStart() {
        ...
        mReAdapter = new NewVideosFragment.myAdapter(myList);
    ...
    public class myAdapter extends RecyclerView.Adapter<NewVideosFragment.myAdapter.MyHolder>{

        ArrayList<DataModel> myList;

        @Override
        public NewVideosFragment.myAdapter.MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.videos_template,parent,false);
            NewVideosFragment.myAdapter.MyHolder holder = new NewVideosFragment.myAdapter.MyHolder(view);
            return holder;
        }
...
//            Glide.with(getContext()).load(thumFile).into(holder.VidV);
            Glide.with(getActivity())
                    .load(Uri.fromFile(new File(f.getAbsolutePath())))
                    .into(holder.VidV);
