...
public class IntaMainActivity extends AppCompatActivity {
...
//    private int[] colors = new int[]{R.color.home, R.color.clock, R.color.folder, R.color.menu};
    private String[] titles = new String[]{"Insta Image", "Insta Video","Insta Profile"};
    private int[] colors = new int[]{R.color.home, R.color.clock, R.color.folder};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameTitle.setText("Instagram");
        mFragmentList.add(new InstaImageFragment(titles[0], colors[0]));
        mFragmentList.add(new InstaVideoFragment(titles[1], colors[1]));
        mFragmentList.add(new InstaProfileFragment(titles[2], colors[2]));
