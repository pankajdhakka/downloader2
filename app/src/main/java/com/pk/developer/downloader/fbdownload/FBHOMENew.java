...
public class FBHOMENew extends AppCompatActivity {
...
//    private int[] colors = new int[]{R.color.home, R.color.clock, R.color.folder, R.color.menu};
    private String[] titles = new String[]{"URL", "Browser"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_f_b_h_o_m_e_new);
        mFragmentList.add(new fragment_fb(titles[0], colors[0]));
        mFragmentList.add(new FBHomeFragment(titles[1], colors[1]));
